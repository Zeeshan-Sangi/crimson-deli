/* Auto-converted from _template/shop-list.html by scripts/html2jsx.mjs — do not hand-edit, re-run the script */
                        ...
                        <div className="container">
                            <div className="page-heading">
                                <div className="breadcrumb-sub-title">
                                    <h1 className="breadcrumb-title text-white split-title">SHOP LISTING</h1>
                                </div>
