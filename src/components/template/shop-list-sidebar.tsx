/* Auto-converted from _template/shop-list-sidebar.html by scripts/html2jsx.mjs — do not hand-edit, re-run the script */
import Link from "next/link";
import Image from "next/image";
import NiceSelect from "@/components/layout/nice-select";

export default function ShopListSidebar() {
  return (
    <>
                        ...
                        <div className="container">
                            <div className="page-heading">
                                <div className="breadcrumb-sub-title">
                                    <h1 className="breadcrumb-title text-white split-title">SHOP List SIDEBAR</h1>
                                </div>
                    ...
                    <section className="food-category-section-4 section-padding fix">
                        <div className="container">
                           ...
                           <div className="row">
                                <div className="col-xl-3 col-lg-5 order-2 order-xl-1">
                                    <div className="shop-sidebar-area">
                                        <div className="shop-sidebar-item active">
                                            <div className="sidebar-header">
                                                <div className="head-title">Product Categories</div>
                                        ...
                                        <div className="shop-sidebar-item active">
                                            <div className="sidebar-header">
                                                <div className="head-title">Filter by price</div>
                                                <i className="fas fa-chevron-down toggle-icon"></i>
                                            </div>
                                            <div className="sidebar-content">
                                                <div className="sidebar-inner">
                                                    <div className="price-filter-widget">
                                                        <div className="slider-wrapper">
                                                            ...
                                                            <input type="range" min="0" max="500" value="0" className="range-min" />
                                                            <input type="range" min="0" max="500" value="100" className="range-max" />
                                                        </div>
                                        ...
                                        <div className="shop-sidebar-item active">
                                            <div className="sidebar-header">
                                                <div className="head-title">Best Seller Item</div>
                                                <i className="fas fa-chevron-down toggle-icon"></i>
                                            </div>
                                            <div className="sidebar-content">
                                                <div className="sidebar-inner">
                                                     <ul className="post-inner">
                                                        <li>
                                                            <div className="thumb">
                                                                <Image src="/assets/img/home-2/best-menu-1.png" alt="img" width={76} height={79} />
                                                            </div>
                                                        ...
                                                        <li>
                                                            <div className="thumb">
                                                                <Image src="/assets/img/home-2/best-menu-2.png" alt="img" width={76} height={79} />
                                                            </div>
                                                            <div className="content">
                                                                <div className="star">
                                                                    <i className="fa-etch fa-solid fa-star"></i>
                                                        ...
                                                        <li>
                                                            <div className="thumb">
                                                                <Image src="/assets/img/home-2/best-menu-3.png" alt="img" width={79} height={79} />
                                                            </div>
                                                            <div className="content">
                                                                <div className="star">
                                                                    <i className="fa-etch fa-solid fa-star"></i>
                                                        ...
                                                        <li>
                                                            <div className="thumb">
                                                                <Image src="/assets/img/home-2/best-menu-4.png" alt="img" width={76} height={79} />
                                                            </div>
                                                            <div className="content">
                                                                <div className="star">
                                                                    <i className="fa-etch fa-solid fa-star"></i>
                                                        ...
                                                        <li>
                                                            <div className="thumb">
                                                                <Image src="/assets/img/home-2/best-menu-5.png" alt="img" width={80} height={79} />
                                                            </div>
                                                            <div className="content">
                                                                <div className="star">
                                                                    <i className="fa-etch fa-solid fa-star"></i>
                                        ...
                                        <div className="shop-sidebar-inner-banner bg-cover" style={{backgroundImage: "url('/assets/img/inner/banner-bg.jpg')"}}>
                                           <div className="content">
                                             <div className="title">
                                                Special Biryani
                                            </div>
                                            <div className="text">PHENOMENON BURGER TASTE</div>
                                           ...
                                           <div className="rice-image">
                                                <Image src="/assets/img/inner/rice.png" alt="img" width={277} height={240} />
                                           </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-9 order-1 order-xl-2">
                                    <div className="tab-content">
                                        <div id="grid" className="tab-pane fade">
                                            <div className="row">
                                                <div className="col-xxl-4 col-xl-6 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                                ...
                                                <div className="col-xxl-4 col-xl-6 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                                    <div className="food-category-items-4">
                                                        <div className="shape">
                                                            <svg width="292" height="162" viewBox="0 0 292 162" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M0 20C0 8.95431 8.95431 0 20 0H272C283.046 0 292 8.9543 292 20V95.3843C292 101.5 289.23 107.256 284.227 110.772C263.695 125.2 205.494 162 146 162C86.5063 162 28.3054 125.2 7.77321 110.772C2.76957 107.256 0 101.5 0 95.3843V20Z" fill="#F4F1EA"></path>
                                                ...
                                                <div className="col-xxl-4 col-xl-6 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                                                    <div className="food-category-items-4">
                                                        <div className="shape">
                                                            <svg width="292" height="162" viewBox="0 0 292 162" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M0 20C0 8.95431 8.95431 0 20 0H272C283.046 0 292 8.9543 292 20V95.3843C292 101.5 289.23 107.256 284.227 110.772C263.695 125.2 205.494 162 146 162C86.5063 162 28.3054 125.2 7.77321 110.772C2.76957 107.256 0 101.5 0 95.3843V20Z" fill="#F4F1EA"></path>
                                                ...
                                                <div className="col-xxl-4 col-xl-6 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                                                    <div className="food-category-items-4">
                                                        <div className="shape">
                                                            <svg width="292" height="162" viewBox="0 0 292 162" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M0 20C0 8.95431 8.95431 0 20 0H272C283.046 0 292 8.9543 292 20V95.3843C292 101.5 289.23 107.256 284.227 110.772C263.695 125.2 205.494 162 146 162C86.5063 162 28.3054 125.2 7.77321 110.772C2.76957 107.256 0 101.5 0 95.3843V20Z" fill="#F4F1EA"></path>
